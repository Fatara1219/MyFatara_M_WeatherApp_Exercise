...
//  MyFatara_M_WeatherApp_Exercise
//
//  Created by Fatara Muhammad on 8/13/20.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let url = NSURL(string:"https://api.darksky.net/forecast/ae58c5fa7285b492f6a553d200018d9e/41.879,-87.6606") {
            if let data = NSData(contentsOf: url as URL){
                
                do {
                    let parsed = try JSONSerialization.jsonObject(with:
                        data as Data, options:JSONSerialization.ReadingOptions.allowFragments)
                    as! [String:AnyObject]
